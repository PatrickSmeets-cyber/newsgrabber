...
# 1. RSS Feeds definieeren
FEEDS = {
    "Wereld": "https://feeds.feedparser.org/nosnieuwsbuitenland",
...
for category, url in FEEDS.items():
    ...
    if feed.entries:
        ...
        # Probeer een afbeelding te vinden
        img_url = "https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=600" # Standaard afbeelding
        ...
        # AI Herschrijven via Gemini API
        ai_summary = summary[:150] + "..." # Fallback als AI faalt
        if api_key:
            try:
                ...
                print(f"AI API fout bij {category}: {e}")
...
<head>
    ...
    <style>
        ...
        header {{ text-align: center; padding: 20px 0; background: linear-gradient(135deg, #FF6B6B, #FFE66D); color: #222; border-radius: 12px; margin-bottom: 20px; font-weight: bold; }}
